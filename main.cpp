...
int main() {
    ...
    parameters.time_interval = {0, 10};
    const std::array<double, 2> init = {1, 0};
    ...
    parameters.tau_init /= 2;
    auto [time2, sol2] = ode::runge_kutta<double, ode::dormand_prince>(parameters, init, system);
